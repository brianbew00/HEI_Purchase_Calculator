...
if "forecast_df" in st.session_state:
    ...
    if chart_view == "Investor Returns":
        ...
        chart_returns = chart_returns.configure_legend(orient='top').configure_axisY(labelPadding=-30, titlePadding=20)
        ...
        chart_metrics = chart_metrics.configure_legend(orient='top').configure_axisY(labelPadding=-30, titlePadding=20)
